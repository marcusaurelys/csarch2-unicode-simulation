    ...
    <p className="font-bold text-3xl mb-3"> Input  </p>
        <div className="flex gap-3">
          ...
          <div className="flex-grow">
            <Input label="UTF-8" placeholder='XX XX XX XX' value={utf8} disabled/>
          </div>
          </div>
          ...
          <div className="flex-grow">
            <Input label="UTF-16" placeholder='XX XX XX XX' value={utf16} disabled/>
          </div>
          </div>
          ...
          <div className="flex-grow">
            <Input label="UTF-32" placeholder='XX XX XX XX' value={utf32} disabled/>
          </div>
          </div>
    </>)
}
